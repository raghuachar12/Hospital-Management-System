...
public class InPatientRecords {
	...
	private void initialize() {
		...
		frameInPatientRecords.setTitle("Patient Details");
		...
		lblNewLabel.setBounds(358, 10, 333, 68);
	...
	private void btnSearchActionperformed(ActionEvent evt)
	{
		...
		try
		{
			...
			String query="select P_ID,P_NAME,WARD_NO,DATE_OF_ADMISSION,DATE_OF_DISCHARGE,LAB_NO,N_ID,D_ID,PH_NO from INPATIENT where P_ID=?";
	...
	private void btnGetActionPerformed(ActionEvent evt)
	{
		try
		{
			...
			String query="select P_ID,P_NAME,WARD_NO,DATE_OF_ADMISSION,DATE_OF_DISCHARGE,LAB_NO,N_ID,D_ID,PH_NO from INPATIENT";
			p=con.prepareStatement(query);
			r=p.executeQuery();
			table.setModel(DbUtils.resultSetToTableModel(r));
		}
